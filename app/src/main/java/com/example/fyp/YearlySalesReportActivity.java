...
public class YearlySalesReportActivity extends AppCompatActivity {

    WebView webView;
    public String url ="http://"+ GetIP.getInstance().getIp() +"/fyp/yearlySalesReport.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spannable spannable = new SpannableString("Yearly Sales Report");
        ...
        webView = (WebView) findViewById(R.id.yearlySalesReportWebView);
