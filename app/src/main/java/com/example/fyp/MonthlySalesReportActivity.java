...
public class MonthlySalesReportActivity extends AppCompatActivity {
    ...
    WebView webView;
    public String url ="http://"+ GetIP.getInstance().getIp() +"/fyp/monthlySalesReport.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spannable spannable = new SpannableString("Monthly Sales Report");
        ...
        webView = (WebView) findViewById(R.id.monthlySalesReportWebView);
